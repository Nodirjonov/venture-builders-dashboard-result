  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-50 hidden h-svh w-(--sidebar-width) transition-[inset-inline,width] duration-200 ease-in-out md:flex',
          side === 'left'
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-start text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pe-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-0! group-data-[collapsible=icon]:gap-0! group-hover:group-data-[collapsible=icon]:w-full! group-hover:group-data-[collapsible=icon]:h-9! group-hover:group-data-[collapsible=icon]:p-2! group-hover:group-data-[collapsible=icon]:gap-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
  ...
  return (
    <ul
      ...
      className={cn(
        ...
        'group-data-[collapsible=icon]:hidden group-hover:group-data-[collapsible=icon]:flex',
        className
      )}
      {...props}
    />
